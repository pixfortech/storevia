...
| Threat                                            | Mitigation                                                                                           | Test                                                   | M   |
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | --- |
| Credential stuffing / brute force                 | Per-IP/per-account/global rate limits, progressive challenge, breached-password check, WAF bot rules | rate-limit tests                                       | 1   |
...
| Open redirect                                       | Redirect targets from an allow-list or relative-path validator; canonical redirects only to DB hosts                                                | redirect tests                                                 | 1, 4 |
