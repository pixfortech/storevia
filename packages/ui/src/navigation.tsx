"use client";
// Navigation controls: Tabs, Breadcrumb, Pagination and the marketing
// header's NavigationMenu (docs/design/design-plan.md §8–§12). Radix supplies
...
import { ChevronDown, ChevronLeft, ChevronRight, Ellipsis, type LucideIcon } from "lucide-react";
import {
  cloneElement,
  createContext,
  isValidElement,
...
/* ----------------------------------------------------------------------------
 * NavigationMenu (marketing header mega-menu)
 * ------------------------------------------------------------------------- */
